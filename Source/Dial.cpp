...
void Dial::addListener(Listener* listener)
{
    listeners.add(listener);
}

void Dial::removeListener(Listener* listener)
{
...
void Dial::updateValue (float newValue)
{
    ...
    listeners.call(&Listener::dialValueChanged, this);
